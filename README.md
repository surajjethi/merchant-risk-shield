...
1.  **Product returns** --- some orders have a higher likelihood of
    being returned, but identifying them early can be difficult.
2.  **Chargebacks** --- when a customer disputes a transaction,
...
![Merchant Risk Shield Login](docs/screenshots/login.png)

### Order Risk Monitoring

![Orders Dashboard](docs/screenshots/orders.png)

### Chargeback & Dispute Management

![Disputes Dashboard](docs/screenshots/disputes.png)
...
![Merchant Risk Shield Architecture](docs/architecture.png)
...
GitHub:
[surajjethi/merchant-risk-shield](https://github.com/surajjethi/merchant-risk-shield)
